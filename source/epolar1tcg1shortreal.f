...
c  
     ...
     $            jxloc,jyloc,jzloc,jjj,jglob,jloc,kkpole,kglob,kloc,
     $            jpoleloc
     ...
     $        arraTA,fphiarrded,fphiarrdep,fphiarrA,fphiaTA,
     $        fphiarrdTr0,arr_dtr0
...
c
     ...
     $    arr_dtr0,r0(1:3,1,1:max(1,npolebloc)),ade,adme,adte,adtb)
