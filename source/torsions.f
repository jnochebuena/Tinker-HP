...
c
c      if (associated(itors)) deallocate (itors)
c      if (associated(tors1)) deallocate (tors1)
c      if (associated(tors2)) deallocate (tors2)
c      if (associated(tors3)) deallocate (tors3)
c      if (associated(tors4)) deallocate (tors4)
c      if (associated(tors5)) deallocate (tors5)
c      if (associated(tors6)) deallocate (tors6)
c      if (associated(kprop)) deallocate (kprop)
c      if (associated(vprop)) deallocate (vprop)
c      if (associated(iiprop)) deallocate (iiprop)
c      if (associated(itors1)) deallocate (itors1)
c      if (associated(itors2)) deallocate (itors2)
c      if (associated(itors3)) deallocate (itors3)
c      if (associated(iitors)) deallocate (iitors)
c      if (associated(iiprop)) deallocate (iiprop)
c      if (associated(kpit)) deallocate (kpit)
c      if (associated(ipit)) deallocate (ipit)
c      if (associated(ist)) deallocate (ist)
c      if (associated(kst)) deallocate (kst)
c      if (associated(nbstrtor)) deallocate (nbstrtor)
