...
!===================================================
      ...
      integer :: nrhs = 2
      integer :: i, iipole, iglob, m1, m2, m3, nf1, nf2, nf3, k1, k2,
     $ k3, k, j , ntot, rankloc, ierr, tag, iloc
      integer :: status(MPI_STATUS_SIZE), commloc, nprocloc
      real*8 :: term, hsq,  r1, r2, r3, h1, h2, h3, volterm, 
     $ pterm, denom, expterm
      real*8, allocatable, dimension(:,:) :: vec_frac1, vec_frac2
      real*8, allocatable, dimension(:,:,:,:) :: qgridout2 , qgridout3
      real*8, allocatable, dimension(:,:,:,:,:) :: qgridin2, qgridin3
      real*8, allocatable :: qgridmpi(:,:,:,:,:)
...
c
      ...
      implicit none
      integer i,ii,iipole,iglob,iz,ix,iy
      integer jj,jjj,jjpole,jglob,jloc,jpoleloc
      integer jx,jy,jz,alphac,betac,jxloc,jyloc,jzloc
      logical doi,doix,doiy,doiz
