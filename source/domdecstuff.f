...
c
      bigbuf = max(mbuf,cbuf,vbuf,dbuf,torquebuf,ddcut)
      bigshortbuf = max(mshortbuf,cshortbuf,torqueshortbuf,vshortbuf,
     $ ddcut)
c
      do iproc = 0, nprocloc-1
...
c
      ...
      integer istep,modnl
      real*8 mbuf,vbuf,torquebuf,neigbuf,bigbuf,dbuf
      real*8 mshortbuf,vshortbuf,torqueshortbuf,bigshortbuf
      real*8 cbuf,cshortbuf
      real*8 dist, scale
