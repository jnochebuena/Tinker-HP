...
c  
      ...
      integer :: ii, iz,ix,iy, alphac, jj, jx, jy, jz, kk, irhs,
     $            i, iipole,jjpole, j, tag, ierr,iglob,ilocrec,
     $            jglob,jloc,kkpole,kglob,kloc,betac
...
c
     ...
     $                              ade, adme, adte, adtb)
         ...
         time0 = mpi_wtime()
         call scalderfieldzmatrec3(nrhs,arr_ded,arr_dedbis,
     $        fphiarrded,arr_dep,arr_depbis,fphiarrdep,
     $        arr_dtr0,arr_dtr0bis,fphiarrdtr0,r0(:,1,:),r0bis(:,1,:),
     $        fphir0(:,1,:),-arrA,
     $        -arrAbis, -fphiarrA,oldaefi(:,1,:),oldaefibis(:,1,:), 
...
c         write(*,*) 'time scalderreal = ',time1-time0
         ...
         time0 = mpi_wtime()
         call scalderfieldzmatrec1(nrhs,arr_ded,arr_dedbis,
     $     fphiarrded,arr_dep,arr_depbis,fphiarrdep,
     $     arr_dtr0,arr_dtr0bis,fphiarrdtr0,r0(:,1,:),r0bis(:,1,:),
