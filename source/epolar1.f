...
c
      ...
      time1 = mpi_wtime()
c      write(*,*) 'time epolar = ',time1-time0
      return
      end
c
c     ###################################################################
...
c
        ...
        ! poner useGEM aqui!
      !print *,'use_polarshortreal ',use_polarshortreal
      !print *,'polalg ',polalg
      !print *,'use_pmecore ',use_pmecore
...
c
      ...
      use mpi
      implicit none
      integer i,j,k,m,iglob,kglob,kbis
      integer ii,kk,kkk,iipole,kkpole,inl
      integer iax,iay,iaz
      real*8 e,efull,f
      real*8 erfc,bfac
      real*8 alsq2,alsq2n
...
c
      ...
      real*8 cphip(4)
      real*8 a(3,3),ftc(10,10),ctf(10,10)
