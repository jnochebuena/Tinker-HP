...
c
     ...
     $         mupeek, ar0, T2r0,  oldr0, oldTr0, mu_tcg1rec,
     $         mu0, mu0bis,tmpbig, at2r0, oldT2r0,res2,res2bis
...
c  
      ...
      implicit none
      logical :: peek, precond, isguess
      integer :: i, iipole, iglob, nrhs, j, k, tag, ierr
      integer :: status(MPI_STATUS_SIZE)
      integer, allocatable :: reqrec(:),reqsend(:)
      integer, allocatable :: reqrecdirrec(:),reqrecdirsend(:)
      integer, allocatable :: req2rec(:),req2send(:)
     ...
     $         mupeek, ar0, T2r0, T2r0bis, P2, Pr0, PTr0, oldr0, oldTr0,
     $         mu0, mu0bis,tmpbig, at2r0, oldT2r0,res2,res2bis
      real*8, allocatable, dimension(:,:,:) :: buffermpimu1,buffermpimu2
      real*8, allocatable, dimension(:,:) :: buffermpi1,buffermpi2
