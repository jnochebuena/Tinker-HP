...
! # of ffts : 5 (efi, r0, Tr0, T2r0, T3r0)
     ...
     $      xx,arr_depbis,fphiarrdep,xx,arr_dedbis,fphiarrded,
     $      xx,arr_dtr0bis,fphiarrdtr0,xx,r0bis(:,1,:),
     $      fphir0(:,1,:),xx,arr_dttr0bis,fphiarrdttr0,
     $      xx,tr0bis(:,1,:),fphitr0(:,1,:),
     $      xx,arr_dtt2r0bis,fphiarrdtt2r0,xx,
...
! Only guess is available (+ prec via 'precond')
     ...
     $      xx,arr_dedbis,fphiarrded,xx,arr_depbis,fphiarrdep, 
     $      xx,arr_dtr0bis,fphiarrdtr0,xx,r0bis(:,1,:),
     $      fphir0(:,1,:),xx,arr_dttr0bis,fphiarrdttr0,
     $      xx,tr0bis(:,1,:),fphitr0(:,1,:),
     $      xx,arr_dtt2r0bis,fphiarrdtt2r0,xx,
     $      t2r0bis(:,1,:), fphit2r0(:,1,:),xx,
     $       -arrAbis, -fphiarrA,xx,mu0bis(:,1,:),fphimu0(:,1,:), 
...
! TRUE
     ...
     $              + ap31 *fphie(:,1,:)+ ap32 *fphite(:,1,:)
        ...
        call scalderfieldzmatrec6(nrhs, 
     $         xx,arr_depbis,fphiarr_dep,xx,arr_dedbis,
     $         fphiarr_ded, 
     $         xx,arr_dtr0bis,fphiarrdtr0,
     $         xx,efibis(:,1,:),
     $         fphie(:,1,:),xx,arr_dttr0bis,
     $         fphiarrdttr0,
     $         xx,tefibis(:,1,:), fphite(:,1,:),
     $         xx,arr_dtt2r0bis,
     $         fphiarrdtt2r0,xx,t2efibis(:,1,:),
     $         fphit2e(:,1,:),
     $         adebis, admebis, adtebis, adtbbis)
