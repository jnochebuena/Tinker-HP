      ...
      subroutine scalderfieldzmat6(nrhs, a1, a2, d1, e1, d2, e2,d3,
     ...
     $                                               d3
      ...
      integer :: ii, iipole, iglob, ipoleloc,  i, inl,jj, jjpole, jglob,
     $           jjj, jbis, alphac, betac, gammac, k, j

      real*8 :: sprod, pti, pdi, rrij3, rrij5, rrij7, rrij9, drr3, drr5,
     $          drr7, drr9, prr3, prr5, prr7, prr9, urr3, urr5, urr7, 
     $scale3, scale5, 
     $          scale7, scale9, dsc3, dsc5, dsc7, dsc9, psc3, psc5,
     $          psc7, psc9, usc3, usc5, usc7, usc9, scalmuir, scalmujr, 
...
c
      subroutine scalderfieldzmat3(nrhs, a1, a2, d1, e1, d2, e2,
     $                                ade, adme, adte, adtb)
      ...
      integer :: ii, iipole, iglob, ipoleloc,  i, inl,jj, jjpole, jglob,
     $           jjj, jbis, alphac, betac, gammac, k, j, jloc
...
!
      subroutine scalderfieldzmatrec6(nrhs,a,abis,fphia,b,bbis,fphib, 
     ...
     $                                                      admerec
      ...
      integer :: i, iipole, iglob, rankloc, j, k, k1, k2, k3, m1, m2,
     $           m3, nf1, nf2, nf3, ntot, l, ii, ilocrec,iloc
      integer, dimension(10) :: deriv1, deriv2, deriv3
      integer, dimension(3,10) :: derivi
      real*8 :: denom, expterm, h1, h2, h3, hsq, pterm, r1, r2, r3,
     $          term, volterm, e
      real*8 :: ctf(10,10)
...
c
      ...
      do i = 1, npolerecloc
         ...
         call cmp_to_fmp_site(ctf,cmp(1,i), fmp(1,i))
...
! 'bis' : only (3,n) vectors in; no nrhs
      subroutine scalderfieldzmatrec8(nrhs,a,abis,fphia,b,bbis,fphib,
     $            d1,d1bis,fphid1,e1,e1bis,fphie1,d2,d2bis,fphid2, 
     $            e2,e2bis,fphie2,d3,d3bis,fphid3,e3,e3bis,fphie3, 
...
! /!\  Finishes with an extra -1 factor !
!
      subroutine scalderfieldzmatrec3(nrhs,a,abis,fphia,b,bbis,
...
! /!\  Finishes with an extra -1 factor !
!
      subroutine scalderfieldzmatrec1(nrhs,a,abis,fphia,b,bbis,fphib,
...
c      vir(3,3) = vir(3,3) -0.5*f*vzz
     ...
     $              + e1_frac(k,i)*fphid1(deriv3(k+1),i)
      ...
      subroutine scalderfieldzmat1(nrhs, a1, a2, d1, e1, 
     $                                ade, adme, adte, adtb)
...
c
      subroutine scalderfieldzmat8(nrhs, a1, a2, d1, e1, d2, e2,d3,
