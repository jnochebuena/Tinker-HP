...
subroutine cfgem_coul(aux_file, list_file, user_coul_file, &
   ...
   use atoms_gem,only : FH_ATOMS_init, &
                        FH_ATOMS_deallocate
...
! Formal arguments:
   ...
   double precision,    intent(out)     :: cfgem_coul_frc(3, atom_cnt)
...
! Local variables:
   ...
   !print *,'input crds in cfgem_coul'
   !do i = 1, atom_cnt
   !   print *,atom_crds(1,i),atom_crds(2,i),atom_crds(3,i)
   !enddo
...
!  if ( verbose == 1 )then
     !print *, '----------------------------------------'
     !print *, 'mpole-mpole components: '
     !print *, 'cutoff_mpole_mpole_ene = ',cutoff_mpole_mpole_ene
     !print *, 'recip_mpole_mpole_ene = ',recip_mpole_mpole_ene
     !print *, 'wigner_mpole_mpole_ene = ',wigner_mpole_mpole_ene
     !print *, 'correct_recip_mpole_mpole_ene = ', &
     !          correct_recip_mpole_mpole_ene
     !print *, 'self_mpole_mpole_ene = ',self_mpole_mpole_ene
     !print *, '----------------------------------------'
     !print *, 'mpole-herm components: '
     !print *, 'cutoff_mpole_herm_ene = ',cutoff_mpole_herm_ene
     !print *, 'recip_mpole_herm_ene = ',recip_mpole_herm_ene
     !print *, 'wigner_mpole_herm_ene = ',wigner_mpole_herm_ene
     !print *, 'correct_recip_mpole_herm_ene = ', &
     !          correct_recip_mpole_herm_ene
     !print *, 'self_mpole_herm_ene = ',self_mpole_herm_ene
     !print *, '----------------------------------------'
     !print *, 'herm-herm components: '
     !print *, 'cutoff_herm_herm_ene = ',cutoff_herm_herm_ene
     !print *, 'recip_herm_herm_ene = ',recip_herm_herm_ene
     !print *, 'wigner_herm_herm_ene = ',wigner_herm_herm_ene
     !print *, 'correct_recip_herm_herm_ene = ', &
     !          correct_recip_herm_herm_ene
     !print *, 'self_herm_herm_ene = ',self_herm_herm_ene
!  endif
   ...
   !print *,'tot coul in cfgem = ',cfgem_tot_coul_ene
   !print *,'mp, mp-h, h-h = ',tot_mpole_mpole_ene, tot_mpole_herm_ene,&
   !                           tot_herm_herm_ene
...
! Formal arguments:
   ...
   double precision,    intent(out)     :: cfgem_exch_frc(3, atom_cnt)
...
! Local variables:
   ...
   !print *,'tot exch in cfgem = ',cfgem_exch_ch_ch_ene
